...
\justifying
 ...
 \\
 A CubeSat will have standard set of satellite subsystems: Structural subsystem, Telemetry, Electrical Power Subsystem (EPS), thermal subsystem (TCS), Attitude Determination and Control Subsystem (ADCS), On Board Computer (OBC) and Payload. For the calculations, we selected payload as a LoRa module which is the payload of GECB satellite program (cite reference). The orbital parameters are given below:
